...
HEART_SCORE = ScoreDefinition(
    ...
    thresholds=[
        ...
        Threshold(
            ...
            6,
            "moderate",
            "Moderate risk for MACE (12-16.6%)",
            "Admit for observation, serial troponins, cardiology consult",
        ),
        Threshold(
            7,
            10,
            "high",
            "High risk for MACE (50-65%)",
            "Aggressive intervention: early invasive strategy, cardiology consult",
        ),
    ],
    max_score=10,
...
CHA2DS2_VASC = ScoreDefinition(
    ...
    deterministic_variables=[
        ...
        VariableDefinition(
            ...
            "Hypertension",
            "deterministic",
            "HTN keyword in history → 1pt",
            max_points=1,
        ),
        VariableDefinition(
            "diabetes", "Diabetes", "deterministic", "DM keyword in history → 1pt", max_points=1
        ),
    ],
    subjective_variables=[
        VariableDefinition(
            ...
            "CHF",
            "subjective",
            "Congestive heart failure or LV dysfunction → 1pt",
            max_points=1,
        ...
        VariableDefinition(
            ...
            "Stroke/TIA",
            "subjective",
            "Prior stroke, TIA, or thromboembolism → 2pts",
            max_points=2,
        ...
        VariableDefinition(
            ...
            "Vascular Disease",
            "subjective",
            "Prior MI, PAD, or aortic plaque → 1pt",
            max_points=1,
    ...
    thresholds=[
        Threshold(
            ...
            0,
            "low",
            "Low risk (0 for males, 1 for females)",
            "No anticoagulation needed (or consider if female with score 1)",
        ),
        Threshold(
            1,
            1,
            "low-moderate",
            "Low-moderate risk",
            "Consider anticoagulation based on individual risk-benefit",
        ),
        Threshold(
            2, 9, "moderate-high", "Moderate-high stroke risk", "Oral anticoagulation recommended"
        ),
    ],
    max_score=9,
...
TIMI_SCORE = ScoreDefinition(
    ...
    deterministic_variables=[
        ...
        VariableDefinition(
            "asa_use", "Aspirin use", "deterministic", "ASA use in past 7 days → 1pt", max_points=1
        ),
        VariableDefinition(
            "elevated_troponin",
            "Elevated troponin",
            "deterministic",
            "Elevated cardiac markers → 1pt",
            max_points=1,
        ),
    ],
    subjective_variables=[
        VariableDefinition(
            "cad_risk_factors_ge3",
            "≥3 CAD risk factors",
            "subjective",
        ...
        VariableDefinition(
            ...
            "ST deviation ≥0.5mm",
            "subjective",
            "ST segment deviation on ECG → 1pt",
            max_points=1,
    ...
    thresholds=[
        Threshold(
            ...
            2,
            "low",
            "Low risk (≤8.3% MACE at 14 days)",
            "Consider early discharge, outpatient stress test",
        ),
        Threshold(
            3,
            4,
            "moderate",
            "Moderate risk (13-20% MACE)",
            "Admit, serial troponins, consider invasive strategy",
        ),
...
WELLS_PE = ScoreDefinition(
    ...
    deterministic_variables=[
        VariableDefinition(
            "hr", "Heart rate >100", "deterministic", "HR >100 → 1.5pts", max_points=2
        ),
        VariableDefinition(
            "prior_dvt_pe",
            "Prior DVT/PE",
            "deterministic",
            "History keyword DVT or PE → 1.5pts",
            max_points=2,
        ),
        VariableDefinition(
            "hemoptysis", "Hemoptysis", "deterministic", "Hemoptysis keyword → 1pt", max_points=1
        ),
    ],
    subjective_variables=[
        VariableDefinition(
            ...
            "subjective",
            "Leg swelling, pain with palpation → 3pts",
            max_points=3,
        ...
        VariableDefinition(
            ...
            "PE is #1 diagnosis",
            "subjective",
            "PE most likely or equally likely diagnosis → 3pts",
            max_points=3,
        ...
        VariableDefinition(
            ...
            "subjective",
            "Recent surgery or immobilization >3 days → 1.5pts",
            max_points=2,
        ...
        VariableDefinition(
            ...
            "Active cancer",
            "subjective",
            "Active cancer (treatment within 6 months or palliative) → 1pt",
            max_points=1,
    ...
    thresholds=[
        ...
        Threshold(
            ...
            12.5,
            "high",
            "High probability PE (37.5%)",
            "CTPA recommended, consider empiric anticoagulation",
        ),
    ],
    max_score=12.5,
...
CURB65 = ScoreDefinition(
    ...
    deterministic_variables=[
        VariableDefinition(
            ...
            "BUN >19 mg/dL",
            "deterministic",
            "BUN >19 (or Urea >7 mmol/L) → 1pt",
            max_points=1,
        ),
        VariableDefinition(
            "rr", "RR ≥30", "deterministic", "Respiratory rate ≥30 → 1pt", max_points=1
        ),
        VariableDefinition(
            "sbp", "SBP <90", "deterministic", "SBP <90 → 1pt (part of BP criterion)", max_points=1
        ),
        VariableDefinition(
            "dbp", "DBP ≤60", "deterministic", "DBP ≤60 → 1pt (part of BP criterion)", max_points=1
        ),
        VariableDefinition("age", "Age ≥65", "deterministic", "Age ≥65 → 1pt", max_points=1),
    ],
    subjective_variables=[
    ...
    thresholds=[
        Threshold(
            ...
            1,
            "low",
            "Low severity pneumonia (0.7-3.2% mortality)",
        ...
        Threshold(
            ...
            2,
            "moderate",
            "Moderate severity (13% mortality)",
            "Consider short inpatient stay or closely supervised outpatient",
        ),
        Threshold(
            3,
            5,
            "high",
            "Severe pneumonia (17-57% mortality)",
            "Hospitalize; consider ICU if score 4-5",
        ),
    ],
    max_score=5,
...
QSOFA = ScoreDefinition(
    ...
    deterministic_variables=[
        VariableDefinition(
            "rr", "RR ≥22", "deterministic", "Respiratory rate ≥22 → 1pt", max_points=1
        ),
        VariableDefinition(
            "sbp", "SBP ≤100", "deterministic", "Systolic BP ≤100 → 1pt", max_points=1
        ),
    ],
    subjective_variables=[
        VariableDefinition(
            ...
            "Altered mentation",
            "subjective",
            "GCS <15 or altered mental status → 1pt",
            max_points=1,
    ...
    thresholds=[
        Threshold(
            ...
            "Continue monitoring; qSOFA <2 does not exclude sepsis",
        ),
        Threshold(
            2,
            3,
            "high",
            "High risk of poor outcome (3-14x mortality)",
            "Assess for organ dysfunction, consider ICU, initiate Sepsis-3 workup",
        ),
    ],
    max_score=3,
...
GCS = ScoreDefinition(
    ...
    subjective_variables=[
        ...
        VariableDefinition(
            ...
            "Motor response",
            "subjective",
            "1=none, 2=extension, 3=flexion, 4=withdrawal, 5=localizes, 6=obeys",
            max_points=6,
    ...
    thresholds=[
        Threshold(
            ...
            "Intubation likely needed; neurosurgery consult",
        ),
        Threshold(
            9,
            12,
            ...
            "Close monitoring, consider ICU, repeat imaging",
        ),
        Threshold(
            13, 15, "mild", "Mild injury or normal (GCS 13-15)", "Observation; discharge if stable"
        ),
    ],
    max_score=15,
    calculate=_calc_gcs,
...
MELD_SCORE = ScoreDefinition(
    ...
    thresholds=[
        ...
        Threshold(
            ...
            19,
            "moderate",
            "Moderate 3-month mortality (6-20%)",
            "Consider hepatology referral, close follow-up",
        ),
        Threshold(
            20,
            29,
            "high",
            "High 3-month mortality (20-45%)",
            "Transplant evaluation, inpatient management",
        ),
        Threshold(
            30,
            40,
            "very_high",
            "Very high 3-month mortality (>70%)",
            "Urgent transplant evaluation, ICU care",
        ),
    ],
    max_score=40,
...
GLASGOW_BLATCHFORD = ScoreDefinition(
    ...
    deterministic_variables=[
        VariableDefinition(
            "bun", "BUN (mg/dL)", "deterministic", "Blood urea nitrogen → 0-6 pts", max_points=6
        ),
        VariableDefinition(
            "hemoglobin",
            "Hemoglobin (g/dL)",
            "deterministic",
            "Sex-adjusted → 0-6 pts",
            max_points=6,
        ),
        VariableDefinition(
            "sbp", "SBP (mmHg)", "deterministic", "Systolic BP → 0-3 pts", max_points=3
        ),
        VariableDefinition("hr", "HR ≥100", "deterministic", "Pulse ≥100 → 1pt", max_points=1),
        VariableDefinition(
            "sex", "Sex", "deterministic", "Used for hemoglobin thresholds", max_points=0
        ),
    ],
    subjective_variables=[
        VariableDefinition(
        ...
        VariableDefinition(
            ...
            "Hepatic disease",
            "subjective",
            "Known liver disease or failure → 2pts",
            max_points=2,
    ...
    thresholds=[
        Threshold(
            ...
            0,
            "low",
            "Very low risk — 0.5% need for intervention",
            "Outpatient management may be safe",
        ),
        Threshold(
            1,
            5,
            "moderate",
            "Moderate risk for GI bleed intervention",
            "Inpatient observation, consider endoscopy",
        ),
        Threshold(
            6,
            23,
            "high",
            "High risk — likely needs intervention",
            "Urgent endoscopy, resuscitation, consider ICU",
        ),
    ],
    max_score=23,
...
RANSONS = ScoreDefinition(
    ...
    deterministic_variables=[
        ...
        VariableDefinition(
            "wbc", "WBC >16k", "deterministic", "WBC >16,000/μL → 1pt", max_points=1
        ),
        VariableDefinition(
            "glucose",
            "Glucose >200",
            "deterministic",
            "Blood glucose >200 mg/dL → 1pt",
            max_points=1,
        ),
    ...
    thresholds=[
        Threshold(
            ...
            2,
            "low",
            "Mild pancreatitis (<5% mortality)",
            "Supportive care, likely short hospital stay",
        ),
        Threshold(
            3,
            4,
            "moderate",
            "Moderate pancreatitis (15-20% mortality)",
            "ICU monitoring, aggressive fluid resuscitation",
        ),
        Threshold(
            5,
            5,
            "high",
            "Severe pancreatitis (>40% mortality)",
            "ICU admission, consider early intervention",
        ),
    ],
    max_score=5,
...
NIHSS = ScoreDefinition(
    ...
    subjective_variables=[
        ...
        VariableDefinition(
            ...
            "Visual fields",
            "subjective",
            "0=no loss, 1=partial hemianopia, 2=complete hemianopia, 3=bilateral",
            max_points=3,
        ...
        VariableDefinition(
            "motor_arm",
            "Motor arm (worst side)",
            "subjective",
            "0=no drift, 1=drift, 2=some effort vs gravity, 3=no effort vs gravity, 4=no movement",
            max_points=4,
    ...
    thresholds=[
        Threshold(
            ...
            "minor",
            "Minor stroke",
            "Consider IV tPA if within window; outpatient workup if stable",
        ),
        Threshold(
            5,
            15,
            "moderate",
            "Moderate stroke",
            "IV tPA + consider thrombectomy; admit to stroke unit",
        ),
        Threshold(
            16,
            20,
            ...
            "IV tPA + thrombectomy evaluation; ICU/neuro ICU",
        ),
        Threshold(
            21,
            42,
            "severe",
            "Severe stroke",
            "Aggressive intervention; neuro ICU; goals-of-care discussion",
        ),
    ],
    max_score=42,
...
def _calc_abcd2(v: dict[str, Any]) -> tuple[int, str]:
    ...
    if (sbp is not None and sbp >= 140) or (dbp is not None and dbp >= 90):
        total += 1
    total += int(
        v.get("clinical_features", 0)
    )  # 0=other, 1=speech impairment, 2=unilateral weakness
...
ABCD2 = ScoreDefinition(
    ...
    deterministic_variables=[
        ...
        VariableDefinition(
            ...
            "SBP ≥140",
            "deterministic",
            "SBP ≥140 → 1pt (part of BP criterion)",
            max_points=1,
        ),
        VariableDefinition(
            "dbp", "DBP ≥90", "deterministic", "DBP ≥90 → 1pt (part of BP criterion)", max_points=1
        ),
        VariableDefinition(
            "diabetes_abcd2",
            "Diabetes",
            "deterministic",
            "Diabetes keyword in history → 1pt",
            max_points=1,
        ),
    ],
    subjective_variables=[
        VariableDefinition(
            ...
            "Clinical features",
            "subjective",
            "0=other, 1=speech impairment without weakness, 2=unilateral weakness",
            max_points=2,
        ...
        VariableDefinition(
            ...
            "Symptom duration",
            "subjective",
            "0=<10 minutes, 1=10-59 minutes, 2=≥60 minutes",
            max_points=2,
    ...
    thresholds=[
        Threshold(
            0, 3, "low", "Low 2-day stroke risk (1%)", "Consider outpatient workup within 24-48h"
        ),
        Threshold(
            4,
            5,
            "moderate",
            "Moderate 2-day stroke risk (4.1%)",
            "Urgent inpatient workup, consider admission",
        ),
        Threshold(
            6,
            7,
            "high",
            "High 2-day stroke risk (8.1%)",
            "Admit for urgent workup, dual antiplatelet, imaging",
        ),
    ],
    max_score=7,
...
SOFA = ScoreDefinition(
    ...
    thresholds=[
        ...
        Threshold(
            ...
            10,
            "moderate",
            "Moderate organ dysfunction (ICU mortality ~30%)",
            "ICU care, aggressive source control",
        ),
        Threshold(
            11,
            15,
            "high",
            "High organ dysfunction (ICU mortality ~50%)",
            "Maximize ICU interventions, consider goals-of-care",
        ),
        Threshold(
            16,
            24,
            "very_high",
            "Very high organ dysfunction (ICU mortality >80%)",
            "Maximal support, palliative care discussion",
        ),
    ],
    max_score=24,
