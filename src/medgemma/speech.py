...
ABBREVIATION_CORRECTIONS = {
    ...
    "SL": ["s l", "s.l."],
    "ETT": ["e t t", "e.t.t."],
    "CPAP": ["c p a p", "c.p.a.p."],
    "STEMI": ["s t e m i", "s.t.e.m.i."],
    "ROSC": ["r o s c", "r.o.s.c."],
    "CPR": ["c p r", "c.p.r."],
    "AED": ["a e d", "a.e.d."],
    "EPI": ["e p i", "e.p.i."],
    "NTG": ["n t g", "n.t.g."],
    "ASA": ["a s a", "a.s.a."],
    "BGL": ["b g l", "b.g.l."],
    "SPO2": ["s p o 2", "s.p.o.2"],
    "ETCO2": ["e t c o 2", "e.t.c.o.2"],
    "AVPU": ["a v p u", "a.v.p.u."],
    "MOI": ["m o i", "m.o.i."],
    "NOI": ["n o i", "n.o.i."],
}
