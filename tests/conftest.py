...
def mock_gemini_client():
    ...
    # Mock analyze_paper
    client.analyze_paper = AsyncMock(
        return_value={
    ...
    client.identify_trends = AsyncMock(
        return_value={
            "trends": [
                {
                    "name": "Test Trend",
    ...
    client.generate_predictions = AsyncMock(
        return_value={
            "predictions": [
                {
    ...
    client.synthesize_weekly = AsyncMock(
        return_value={
    ...
    # Mock analyze_error
    client.analyze_error = AsyncMock(
        return_value={
            "error_analysis": {
...
def mock_knowledge_graph():
    ...
    kg.get_prediction_accuracy = AsyncMock(
        return_value={
            "total": 10,
            "correct": 7,
            "incorrect": 2,
...
def mock_medgemma_client():
    ...
    client.synthesize_evidence = AsyncMock(
        return_value={
...
def mock_symptom_analyzer():
    ...
    analyzer = MagicMock()
    analyzer.analyze_symptoms = AsyncMock(
        return_value={
            ...
            "possible_conditions": [
                ...
                },
                {
                    ...
                    "description": "May need medication",
                },
            ],
            "recommendations": [
...
def mock_medication_checker():
    ...
    checker = MagicMock()
    checker.check_interactions = AsyncMock(
        return_value={
            "safe": False,
            "interactions": [
                {
...
def mock_scheduler_agent():
    ...
    agent.create_appointment = AsyncMock(
        return_value={
            "success": True,
            "appointment": {
                "id": "apt-12345",
    ...
    agent.find_available_slots = AsyncMock(
        return_value={
    ...
    agent.get_appointments = AsyncMock(
        return_value=[
            {
                "id": "apt-12345",
                "patient_name": "John Doe",
    ...
    agent.cancel_appointment = AsyncMock(
...
def mock_clinical_agent():
    ...
    agent = MagicMock()
    agent.ask_clinical_question = AsyncMock(
        return_value=MagicMock(
            ...
            papers=[{"id": "pmid-123", "title": "Metformin Study", "source": "pubmed"}],
